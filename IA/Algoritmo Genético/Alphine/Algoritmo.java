...
public class Algoritmo {
    ...
    //Podemos expandir a função de forma:
    //f(x1​,x2​)=x1​*sin(x1​)* x2​*sin(x2​)
    ...
    public void executar() {
        ...
        for (int geracao = 1; geracao <= num_Geracoes; geracao++) {
            ...
            for (Individuo individuo : populacao) {
                if (individuo.fitness > melhor) melhor = individuo.fitness;
                if (individuo.fitness < pior) pior = individuo.fitness;
